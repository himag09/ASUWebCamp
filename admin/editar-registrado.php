  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Editar Registro de Usuario Manual
              </h1>
                  ...
                  <form method="POST" action="modelo-registro.php" name="guardar-registro" id="guardar-registro">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                              ...
                              <input value="<?php echo $registrado['nombre_registrado']; ?>" type="text" class="form-control" id="apellido" name="apellido" placeholder="Apellido">
                            </div>
                            <div class="form-group">
                                ...
                                <ul class="lista-precios clearfix row">
                                    <li class="col-md-4 align-self-end">
                                      <div class="tabla-precio text-center p-1">
                                          ...
                                          <div class="orden">
                                              ...
                                              <input value="<?php if (isset($boletos['un_dia'])) { echo $boletos['un_dia']; } ?>" type="number" class="form-control" id="pase_dia" name="boletos[]" min="0" size="3" placeholder="0">
                                          </div>
                                      </div>
                                    </li><!-- lista precio-->
                                    <li class="col-md-4 align-self-end">
                                    <div class="tabla-precio text-center p-1">
                                        ...
                                        <div class="orden">
                                            ...
                                            <input value="<?php if (isset($boletos['pase_completo'])) { echo $boletos['pase_completo']; } ?>" type="number" class="form-control" id="pase_completo" name="boletos[]" min="0" size="3" placeholder="0">
                                        </div>
                                    </div>
                                    </li><!-- lista precio-->
                                    <li class="col-md-4 align-self-end">
                                    <div class="tabla-precio text-center p-1">
                                        ...
                                        <div class="orden">
                                            ...
                                            <input value="<?php if (isset($boletos['pase_2dias'])) { echo $boletos['pase_2dias']; } ?>" type="number" class="form-control" id="pase_dosdias" name="boletos[]" min="0" size="3" placeholder="0">
                                ...
                                <div class="caja clearfix row">
                                    <div class="extras col-md-6">
                                        <div class="orden">
                                            ...
                                            <input value="<?php if(isset($boletos['camisas'])){echo $boletos['camisas'];} ?>" type="number" class="form-control" min="0" id="camisa_evento" name="pedido_extra[camisas][cantidad]" placeholder="0">
                                            <input type="hidden" value="10" name="pedido_extra[camisas][precio]">
                                        </div> <!--.orden-->
                                        <div class="orden">
                                            <label for="etiquetas">Paquete de 10 etiquetas $2 <small>(HTML5, CSS3, JavaScript, Chrome)</small></label>
                                            <input value="<?php if(isset($boletos['etiquetas'])){echo $boletos['etiquetas'];} ?>" type="number" class="form-control" min="0" id="etiquetas" name="pedido_extra[etiquetas][cantidad]" placeholder="0">
                                        ...
                                        <div class="orden">
                                            ...
                                            <select id="regalo" name="regalo" required class="form-control seleccionar">
                                                <option value="" disabled>-Seleccione un regalo-</option>
